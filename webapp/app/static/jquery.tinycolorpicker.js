    ...
    function Plugin($container, options) {
        ...
        function _getColorCanvas(event) {
            if(mouseIsDown) {
                ...
                // Reencode colors
                // Red
                if ((colorData[0] == 0xfe) && (colorData[1] == 0x27) && (colorData[2] == 0x12))
                {
                    colorData[0] = 0xff;
                    colorData[1] = 0;
                    colorData[2] = 0;
                }
                else if ((colorData[0] == 0x66) && (colorData[1] == 0xb0) && (colorData[2] == 0x32))
                {
                    colorData[0] = 0;
                    colorData[1] = 0xff;
                    colorData[2] = 0;
                }
                else if ((colorData[0] == 0x02) && (colorData[1] == 0x47) && (colorData[2] == 0xfe))
                {
                    colorData[0] = 0;
                    colorData[1] = 0;
                    colorData[2] = 0xff;
